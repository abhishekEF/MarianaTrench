...
# corescore_packages documentation build
...
from corescore_packages import __version__ as release

# -- Project information -----------------------------------------------------

project = "corescore_packages"
author = "Kedro"
...
htmlhelp_basename = "corescore_packagesdoc"
...
latex_documents = [
    (
        master_doc,
        "corescore_packages.tex",
        "corescore_packages Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "corescore_packages",
        "Project corescore_packages codebase.",
        "Data-Science",
    )
]
